...
with open(file=f"/workspaces/ubuntu/pearl-hacks-25/mentorinfo.txt", mode="w") as new_letter:
...
for mentor, score in top_matches:
    ...
    with open(file=f"/workspaces/ubuntu/pearl-hacks-25/mentorinfo.txt", mode="a") as new_letter:
